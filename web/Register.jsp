                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                          ...
                          <form class="user" action="controller?a=NewUser" method="POST">
                              ...
                              <div class="form-row">
			                     ...
			                     <div class="form-group col-md-6">
			                       <label>Role</label><br>
			                       <div class="custom-control custom-radio custom-control-inline">
			                         <input type="radio" id="Employee" name="role" class="custom-control-input" value="Employee" checked="">
			                         <label class="custom-control-label" for="Employee">Employee</label>
			                       </div>
			                       <div class="custom-control custom-radio custom-control-inline">
			                         <input type="radio" id="Employer" name="role" class="custom-control-input" value="Employer">
